...
const Footer = () => {
  ...
  const contactDetails = [
    {
      icon: Mail,
      label: "divyanshtripathi204@gmail.com",
      href: "mailto:divyanshtripathi204@gmail.com",
  ...
  const socialLinks = [
    {
      icon: Github,
      href: "https://github.com/divyansh-tripathi",
      label: "GitHub",
    ...
    {
      icon: Linkedin,
      href: "https://www.linkedin.com/in/divyansh-tripathi01/",
      label: "LinkedIn",
